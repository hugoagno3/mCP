#' mCP_dynamic function: Targeted analysis of protein complexes extended to a low number of fractions. 
#'
...
#'data("Hek293_P2_1")
#'mCP_Hek_P2_1 <- mCP_dynamic(corum_database = Corum_Humans_Database,
...
#'data("CM_LV_1")
#'mCP_TEND_out_WT_Mouse_Cardiac <- mCP_dynamic(corum_database = Corum_Mouse_Database,
...
mCP_dynamic <- function(corum_database, experiment_data, N_fractions=35, specie= "hsapiens",
