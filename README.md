...
I created mCP to aliveate the need of deep expertise in data analysis, but in case you need specific support service, I provide data analysis support that includes use of mCP, and interactomics tools for complexome profiling:
...
library(devtools)
devtools::install_github("hugoagno3/mCP", build_vignettes = TRUE)
```
